...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/08 19:06:02 by hsybassi          #+#    #+#             */
/*   Updated: 2022/03/08 19:06:02 by hsybassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			create_stack(t_storage **storage, t_stack **top,
					int value, int order);
...
void			assign_order_to_numbers(t_storage **storage,
					int *array, int size);
